...
const FriendsCard = ({ friend }) => {
  ...
  return (
    <Link href={`/friends/${id}`} className="border border-[hsl(0,2%,94%)]  shadow-md rounded-md py-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02] cursor-pointer ">
